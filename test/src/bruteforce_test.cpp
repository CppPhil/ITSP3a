...
TEST_CASE("bruteforce_test")
{
    ...
    CHECK(itsp3::bruteforce(makePasswordChecker("a"), itsp3::asciiAlphabet)
          == "a");

    CHECK(itsp3::bruteforce(makePasswordChecker("ab"), itsp3::asciiAlphabet)
          == "ab");

    CHECK(itsp3::bruteforce(makePasswordChecker("abc"), itsp3::asciiAlphabet)
          == "abc");
}
